...
window.TRAINER_DATA = {
  ...
  changes: [
    ...
    },
    {
      ...
      why: '締めの一文が「読んでいる」でなく「話している」に聞こえる。',
    },
    {
      original: 'gravitational waves',
      replacement: 'black holes',
      why: '発音が格段に楽（5音節→2音節×2）。映像素材も豊富で絵になる。⚠️Philip チームが列挙部分の B-roll を探しているので要連絡。',
    },
    {
      original: "We won't just memorize facts.",
      replacement: 'We will not just memorize facts.',
      why: "won't は want に聞こえる事故リスクが高い。will not にすると次文の We will explore と「will not ／ will」の対句になり、断言として強くなる。",
    },
    {
      original: '…black holes, the first galaxies, and the search for life.',
      replacement: '…black holes, galaxies, and the search for life.',
      why: 'first galaxies は既に P3（JWST の文）に出ており重複。講義の topic としては galaxies 全般の方が正確で、リズムも締まる。',
    },
    {
      original: 'It is built for curious first-year science students who want to see the Universe as a whole.',
      replacement: "It's built for first-year science students who are curious about everything.",
      why: '修飾語3連＋science students の子音衝突を解消。curious を独立した強勢位置に出せる。everything が締めの "where everything comes from" と呼応。',
    },
    {
      original: 'come find out with us.',
  ...
  paragraphs: [
    ...
    },
    {
      ...
      text: 'That\'s what AST121, "Twinkle, Sparkle, Brilliant Sky," is really about. We will not just memorize facts. We will explore the modern Universe through its biggest open questions: the Big Bang, dark matter, black holes, galaxies, and the search for life.',
      sentences: [
        'That\'s what AST121, "Twinkle, Sparkle, Brilliant Sky," is really about.',
        'We will not just memorize facts.',
        'We will explore the modern Universe through its biggest open questions: the Big Bang, dark matter, black holes, galaxies, and the search for life.',
      ],
    },
    {
      label: '誰のための講義か', cue: "It's built for…", camera: 'vo',
      visual: '宇宙全体へズームアウト',
      deliveryNote: '落ち着いて温かく。curious を独立させて強く置く。everything は締めの一文と呼応するので少し伸ばして ↘。',
      text: "It's built for first-year science students who are curious about everything.",
      sentences: [
        "It's built for first-year science students who are curious about everything.",
      ],
    },
    {
      label: '締め（CTA）', cue: "If you've ever wondered…", camera: 'on',
      visual: '最後は顔出しで締め',
      deliveryNote: 'ひと呼吸置いてから、にこやかに言い切る。"let\'s find out together" は FIND に山を置き、together をゆっくり下げて着地。',
      text: "If you've ever wondered where everything comes from, let's find out together.",
      sentences: [
        "If you've ever wondered where everything comes from, let's find out together.",
      ],
    },
  ],
  ...
  drills: {
    words: [
      ...
      { word: 'holes', ipa: '/ˈhoʊlz/', stress: 'HOLES (1音節)', category: 'final-consonant', tip_ja: '「ホールズ」と伸ばさず1音節。二重母音 /oʊ/「ホウ」→ 舌先を歯茎に付ける暗いL → z。最後に「ズ」の母音を足さない。' },
      ...
      { word: 'together', ipa: '/təˈɡɛðɚ/', stress: 'to-GE-ther', category: 'TH', tip_ja: '締めの最終語。強勢は真ん中 GE。th は有声 /ð/（舌先を歯に当てて震わせる。「ザー」で代用しない）。「トゥギャザー」と平板にせず、GE を高く → ther をゆっくり下げて着地。' },
    ...
    phrases: [
      ...
      { text: "let's find out together", focus: 'linking', tip_ja: "let's は /lɛts/、ts を潰さず一息で。find の d を out に渡して fin-DOUT と1語のように。together は to-GE-ther（有声 th）。締めの一文なので FIND に山、together をゆっくり ↘ で着地させる。" },
