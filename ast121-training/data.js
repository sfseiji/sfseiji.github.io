...
window.TRAINER_DATA = {
  ...
  paragraphs: [
    ...
    },
    {
      ...
      visual: 'ピッチは顔出し → トピック列挙は映像（Big Bang・dark matter・重力波）',
      deliveryNote: 'ピッチはカメラ目線。タイトルはコンマで間を取りながら1語ずつ。列挙は1項目ずつ等リズムで。',
      text: 'That\'s what AST121, "Twinkle, Sparkle, Brilliant Sky," is really about. We won\'t just memorize facts. We will explore the modern Universe through its biggest open questions: the Big Bang, dark matter, gravitational waves, the first galaxies, and the search for life.',
      sentences: [
        'That\'s what AST121, "Twinkle, Sparkle, Brilliant Sky," is really about.',
        "We won't just memorize facts.",
        'We will explore the modern Universe through its biggest open questions: the Big Bang, dark matter, gravitational waves, the first galaxies, and the search for life.',
      ],
    },
    {
  ...
  drills: {
    words: [
      ...
      { word: 'gravitational', ipa: '/ˌɡrævəˈteɪʃənəl/', stress: 'gra-vi-TA-tion-al', category: 'stress', tip_ja: '5音節で主強勢は TA（二重母音 /teɪ/ ではっきり）。前半 /ɡrævə/ は弱く速く、v は下唇+上歯。「グラビテーショナル」と全拍均等が最大の罠。語尾 /ʃənəl/ は転がして小さく。' },
    ...
    phrases: [
      ...
      { text: 'gravitational waves', focus: 'stress', tip_ja: '山は TA と WAVES の2つだけ：gra-vi-TA-tion-al WAVES。前半5音節を弱く速く転がすのが練習の核心。waves は w で唇を丸め、語尾 /vz/ に母音を足さない（「ウェーブス」禁止）。' },
